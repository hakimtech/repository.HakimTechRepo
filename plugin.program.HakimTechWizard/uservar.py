...
ADDONTITLE     = 'Hakim Technology Wizard'
EXCLUDES       = [ADDON_ID, 'plugin.program.HakimTechWizard']
...
THEME1         = '[COLOR '+COLOR1+'][B][I]([COLOR '+COLOR2+']Hakim Technology Wizard[/COLOR])[/B][/COLOR] [COLOR '+COLOR2+']%s[/COLOR][/I]'
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Hakim Technology Wizard.\r\n\r\nContact us on facebook at http://facebook.com'
...
NOTIFICATION   = 'http://hakimtechnology.com/HakimTech/TextFiles/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
HEADERMESSAGE  = 'Hakim Technology Wizard'
