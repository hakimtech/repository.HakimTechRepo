...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.royalty/resources/ivue','royalty.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.royalty/resources/ivue','plugin.video.royalty.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.royalty'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("royalty","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.royalty/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.royalty/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("royalty","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("royalty","Installing iVue TV Guide...",'', 'Please Wait')
