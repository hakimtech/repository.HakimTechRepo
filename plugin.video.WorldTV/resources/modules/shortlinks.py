...
def Get():
	...
	m3u  = 'http://royaltv.xyz:25461%3A25461%2Fget.php%3Fusername%3D'+username+'%26password%3D'+password+'%26type%3Dm3u_plus%26output%3Dts'
	epg  = 'http://royaltv.xyz:25461%3A25461%2Fxmltv.php%3Fusername%3D'+username+'%26password%3D'+password
	auth = 'http://royaltv.xyz:25461/enigma2.php?username='+username+'&password='+password+'&type=get_vod_categories'
	...
	if not auth=="":
		...
		xbmcgui.Dialog().ok('Royalty Tv','[COLOR blue]M3U URL: [/COLOR]%s'%shortm3u,'','[COLOR blue]EPG URL: [/COLOR]%s'%shortepg)
	else:
		return